...
def viewBookings():
    ...
    response_json = json.loads(response.text)
    bookings = pd.DataFrame(response_json)
    # TODO: how to exclude bookings that have been cancelled?
    return bookings[['BookingID', 'ReservationGUID', 'Name', 'StartDate', 'LocationDescription']] 

def cancelBooking(reservation_guid):
    headers = {
        'authority': 'antrimandnewtownabbey.legendonlineservices.co.uk',
        'accept': 'application/json, text/javascript, */*; q=0.01',
        'accept-language': 'en-GB,en-US;q=0.9,en;q=0.8',
    ...
    params = {
        'reservationGuid': reservation_guid,
        '_': '1709621763358',
    }
